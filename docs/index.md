...
Type | Required | Comments
-----|----------|---------
[Binary](https://johnstonskj.github.io/thrift-specs/protocol-binary.md)    | Minimal required |
Multiplex | Minimal required |
[JSON](https://johnstonskj.github.io/thrift-specs/protocol-json.md) | Minimal recommended |
